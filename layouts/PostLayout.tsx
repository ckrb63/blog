      ...
      <article>
        <div className="xl:divide-y xl:divide-gray-200 xl:dark:divide-gray-700">
              ...
              <dl className="space-y-10">
                <div>
                  ...
                  <dd className="flex items-center justify-center text-base font-medium leading-6 text-gray-500 dark:text-gray-400">
                    <time dateTime={date}>
                      {new Date(date).toLocaleDateString('ko-KR', postDateTemplate)}
                    </time>
          ...
          <div className="grid-rows-[auto_1fr] divide-y divide-gray-200 pb-8 dark:divide-gray-700 xl:grid xl:grid-cols-4 xl:gap-x-6 xl:divide-y-0">
            <dl className="pb-10 pt-6 xl:border-b xl:border-gray-200 xl:pt-11 xl:dark:border-gray-700"></dl>
            ...
            <footer>
              ...
              <div className="pt-4 xl:pt-8">
                ...
                >
                  &larr; <p className="ml-1 mt-1">전체 포스팅</p>
                </Link>
              </div>
            </footer>
          </div>
